...
public class App {
    ...
    public static void main(String args[]) {
        ...
        while (isOpcaoValida(opcao)) {
            ...
            opcao = JOptionPane.showInputDialog(null,
                    "Digite 1 para cadastro, 2 para consulta, 3 para deletar, 4 para alteração ou 5 para sair",
                    "Green dinner", JOptionPane.INFORMATION_MESSAGE);
        }
    }
    ...
    private static void consultar(String dados) {
        ...
        Client client = iClientDAO.consult(Long.parseLong(dados));
        if (client != null) {
            JOptionPane.showMessageDialog(null, "Cliente encontrado: " + ((Client) client).toString(), "Sucesso",JOptionPane.INFORMATION_MESSAGE);
        } else {
    ...
    private static void cadastrar(String dados) {
        ...
        //Client client = new Client(dadosSeparados[0],dadosSeparados[1],null,dadosSeparados[3],dadosSeparados[4],dadosSeparados[5],dadosSeparados[6])
